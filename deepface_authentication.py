...
while(True):
    ...
    if detected_face[0]['confidence'] > 0:
      ...
      response = DeepFace.find(img_path = frame, db_path = "faces/train_database", model_name = models[2], distance_metric = metrics[0], enforce_detection = False, detector_backend = 'opencv')
