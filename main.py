...
from deepface_authentication import FaceRecognition
...
def handle_AI():
    while True:
        text_to_speech("Chào mừng bạn đến với hệ thống. Nếu bạn đã có tài khoản, xin vui lòng nhấn phím 1, nếu chưa có tài khoản, xin vui lòng nhấn phím 2.")
        ...
        if int(input()) == 1:
            ...
            if authentication == True:
                ...
                client.publish("smart-home.door", 1) 
                while True:
                    greet = "Chào " + str(name) + ". Nếu muốn sử dụng trợ lý ảo, xin vui lòng nhấn phím 1"
                    text_to_speech(greet)
                    if int(input()) == 1:
                        run_voice_bot()
                    else:
                        break
