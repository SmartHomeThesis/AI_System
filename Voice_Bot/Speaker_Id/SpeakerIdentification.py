...
def train_model():
    ...
    src = os.path.join(path, "training")
    dest = src = os.path.join(path, "models")
    train_file = os.path.join(src, "training_set_addition.txt")    
...
def test_model():
    ...
    src = os.path.join(path, "testing")
    dest = src = os.path.join(path, "models")
    test_file = os.path.join(src, "testing_set_addition.txt")    
